...
clf = ensemble.RandomForestRegressor(n_jobs=-1, n_estimators=80, verbose = 1)
#clf = ensemble.ExtraTreesRegressor(n_estimators=100, n_jobs=-1)
#clf = tree.DecisionTreeRegressor()
#clf = neighbors.KNeighborsRegressor(n_jobs=-1, n_neighbors = 20)
print " ... [OK]"
...
print "Building a forest of trees from the training set for n_estimators"
clf.fit(train, labels)
print " ... [OK]"


#print "Printing OOB score for n_estimators= 20"
...
#plt.plot(train, labels, 'ro', linewidth=5.0)
